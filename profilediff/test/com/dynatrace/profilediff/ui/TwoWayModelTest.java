...
public class TwoWayModelTest extends ModelTest_GEH_SystemProfile_Base {
	
	@AfterClass
	public static void afterClass() {
		Assert.assertTrue("Unchecked models of change items: " + uncheckedModels2Way,  uncheckedModels2Way.isEmpty());
		Assert.assertTrue("Unchecked changed elements of change items: " + uncheckedChangedElements2Way,  uncheckedChangedElements2Way.isEmpty());
	}
	...
	public void changes() throws XMLStreamException, IOException {
		...
		checkCollectChangedElements(Arrays.asList(
				...
				, "(#) measure:Web Page Requests:Business Transaction Results:Value:Web Page Requests"
				, "(#) measure:webrequests - 0s to 1s:Business Transaction Results:Value:webrequests - 0s to 1s"
				), attributes + insertions, item, xmlRight);
		...
		checkCollectChangedElements(Arrays.asList(
				...
				, "(#) measure:webrequests - 0s to 1s:Business Transaction Results:Value:webrequests - 0s to 1s"
				, "(-) actionref:com.dynatrace.diagnostics.logging"
				), attributes + deletions, item, xmlLeft);
	}
	...
	public void attributes() throws XMLStreamException, IOException {
		...
		checkCollectChangedElements(Arrays.asList(
				...
				, "(#) measure:Web Page Requests:Business Transaction Results:Value:Web Page Requests"
				, "(#) measure:webrequests - 0s to 1s:Business Transaction Results:Value:webrequests - 0s to 1s"
				), attributes, item, xmlLeft); // That's correct - attributes only collected on right side.
	}
	...
	public void normalRight() throws XMLStreamException, IOException {
		...
		checkCollectChangedElements(Arrays.asList(
				...
				, "(#) measure:webrequests - 0s to 1s:Business Transaction Results:Value:webrequests - 0s to 1s"
				, "(-) actionref:com.dynatrace.diagnostics.logging"
				), deletions + attributes, item, xmlLeft);
	}
	...
	static void checkAttributes(List<String> expected, XmlElement element, boolean compare, boolean changesOnly, boolean allAttributes, boolean includeChildren) {
		Object[][] tableData = TwoWayModel.enumAttributes(element, compare, changesOnly, allAttributes, includeChildren);
	...
	public void enumAttributes() {
		...
		
		{
			...
			checkAttributes(Arrays.asList(
					...
					, "AttributeValueDifferent: gomezconvergenceid | 938955022"
					, "AttributeValueDifferent: modifiedby | ramkumar_m"
					, "ElementHeader: technology:java | dynatrace/systemprofile/technology:java"
					, "AttributeAdded: type | java"
					...
					, "AttributeValueDifferent: hostpattern | geh-p-ma-app"
					, "AttributeValueDifferent: namepattern | geh-p-ma-app"
					...
					, "AttributeValueDifferent: hostpattern | geh-p-ma-web"
					, "AttributeValueDifferent: namepattern | geh-p-ma-web"
					, "ElementHeader: measure:Sun/Oracle Compressed class space used:Java Virtual Machine:Memory Pool | dynatrace/systemprofile/measures/measure:Sun/Oracle Compressed class space used:Java Virtual Machine:Memory Pool"
					, "AttributeAdded: autosubscribed | true"
					, "AttributeAdded: calculatebaseline | false"
					, "AttributeAdded: calculatepercentiles | false"
					, "AttributeAdded: description | Amount of memory currently used, committed or maximal assigned to a specific memory pool. Please specify the Java Virtual Machine, memory pool name and desired value (used, committed or max). Note: This metric is only available on JVMs version 5.0 or higher."
					, "AttributeAdded: displayaggregations | 23"
					, "AttributeAdded: displayunit | megabytes"
					, "AttributeAdded: errorseverity | none"
					, "AttributeAdded: errortype | none"
					, "AttributeAdded: id | Sun/Oracle Compressed class space used"
					, "AttributeAdded: isaggregated | false"
					, "AttributeAdded: isapplicationaggregated | true"
					, "AttributeAdded: ischartable | true"
					, "AttributeAdded: measuretype | MemoryPoolMeasure"
					, "AttributeAdded: metricgroupid | Java Virtual Machine"
					, "AttributeAdded: metricid | Memory Pool"
					, "AttributeAdded: rate | purepath"
					, "AttributeAdded: servicecontext | SERVER"
					, "AttributeAdded: userdefined | true"
					, "ElementHeader: memorypoolmeasureconfig | dynatrace/systemprofile/measures/measure:Sun/Oracle Compressed class space used:Java Virtual Machine:Memory Pool/memorypoolmeasureconfig"
					, "AttributeAdded: jvmid | 0"
					, "AttributeAdded: memorypoolattributeid | 0"
					, "AttributeAdded: memorypoolid | 7"
					, "ElementHeader: measure:Sun/Oracle Metaspace used:Java Virtual Machine:Memory Pool | dynatrace/systemprofile/measures/measure:Sun/Oracle Metaspace used:Java Virtual Machine:Memory Pool"
					, "AttributeAdded: autosubscribed | true"
					, "AttributeAdded: calculatebaseline | false"
					, "AttributeAdded: calculatepercentiles | false"
					, "AttributeAdded: description | Amount of memory currently used, committed or maximal assigned to a specific memory pool. Please specify the Java Virtual Machine, memory pool name and desired value (used, committed or max). Note: This metric is only available on JVMs version 5.0 or higher."
					...
					, "AttributeAdded: errorseverity | none"
					, "AttributeAdded: errortype | none"
					, "AttributeAdded: id | Sun/Oracle Metaspace used"
					, "AttributeAdded: isaggregated | false"
					, "AttributeAdded: isapplicationaggregated | true"
					, "AttributeAdded: ischartable | true"
					, "AttributeAdded: measuretype | MemoryPoolMeasure"
					...
					, "AttributeAdded: servicecontext | SERVER"
					, "AttributeAdded: userdefined | true"
					, "ElementHeader: memorypoolmeasureconfig | dynatrace/systemprofile/measures/measure:Sun/Oracle Metaspace used:Java Virtual Machine:Memory Pool/memorypoolmeasureconfig"
					, "AttributeAdded: jvmid | 0"
					, "AttributeAdded: memorypoolattributeid | 0"
					, "AttributeAdded: memorypoolid | 6"
					...
					, "AttributeValueDifferent: calculatebaseline | true"
					...
					, "AttributeValueDifferent: calculatebaseline | true"
					, "ElementHeader: property | dynatrace/systemprofile/configurations/configuration:Default/sensorconfig:hybris accelerator/sensor:com.dynatrace.diagnostics.knowledgesensor.dotnet.aspnet/property"
					, "AttributeAdded: alwayssenddynatraceheader | false"
					, "AttributeAdded: aspnetmvc | true"
					, "AttributeAdded: enforcealwayssenddynatraceheader | false"
					, "AttributeAdded: enforcealwayssenddynatraceheadergomezapm | false"
					, "AttributeAdded: outmost | true"
					, "AttributeAdded: type | httpheader"
					, "ElementHeader: property | dynatrace/systemprofile/configurations/configuration:Default/sensorconfig:hybris accelerator/sensor:com.dynatrace.diagnostics.knowledgesensor.euem.webserver/property"
					, "AttributeAdded: alwayssenddynatraceheader | false"
					, "AttributeAdded: aspnetmvc | true"
					, "AttributeAdded: enforcealwayssenddynatraceheader | false"
					, "AttributeAdded: enforcealwayssenddynatraceheadergomezapm | false"
					, "AttributeAdded: outmost | true"
					, "AttributeAdded: type | httpheader"
					, "ElementHeader: property | dynatrace/systemprofile/configurations/configuration:Default/sensorconfig:hybris webserver/sensor:com.dynatrace.diagnostics.knowledgesensor.dotnet.aspnet/property"
					, "AttributeAdded: alwayssenddynatraceheader | false"
					, "AttributeAdded: aspnetmvc | true"
					, "AttributeAdded: enforcealwayssenddynatraceheader | false"
					, "AttributeAdded: enforcealwayssenddynatraceheadergomezapm | false"
					, "AttributeAdded: outmost | true"
					, "AttributeAdded: type | httpheader"
					, "ElementHeader: property | dynatrace/systemprofile/configurations/configuration:Default/sensorconfig:hybris webserver/sensor:com.dynatrace.diagnostics.knowledgesensor.java.servlet/property"
					, "AttributeAdded: alwayssenddynatraceheader | false"
					, "AttributeAdded: aspnetmvc | true"
					, "AttributeAdded: enforcealwayssenddynatraceheader | false"
					, "AttributeAdded: enforcealwayssenddynatraceheadergomezapm | false"
					...
					, "AttributeValueDifferent: autodetecttype | autodetect_none"
					, "ElementHeader: application | dynatrace/systemprofile/uemconfiguration/applications/application"
					, "AttributeAdded: autodetecttype | none"
					, "AttributeAdded: isdefault | false"
					, "AttributeAdded: name | General Electric Application"
					, "ElementHeader: uripattern | dynatrace/systemprofile/uemconfiguration/applications/application/uripatterns/uripattern"
					, "AttributeAdded: match | starts"
					, "AttributeAdded: pattern | http"
					, "ElementHeader: application | dynatrace/systemprofile/uemconfiguration/applications/application"
					, "AttributeAdded: autodetecttype | none"
					, "AttributeAdded: isdefault | false"
					, "AttributeAdded: name | services.gehealthcare.com"
					, "ElementHeader: uripattern | dynatrace/systemprofile/uemconfiguration/applications/application/uripatterns/uripattern"
					, "AttributeAdded: match | contains"
					, "AttributeAdded: pattern | https://services.gehealthcare.com/gehcstorefront/"
					, "ElementHeader: uripattern | dynatrace/systemprofile/uemconfiguration/applications/application/uripatterns/uripattern"
					, "AttributeAdded: match | contains"
					, "AttributeAdded: pattern | http://services.gehealthcare.com/gehcstorefront/"
					, "ElementHeader: uripattern | dynatrace/systemprofile/uemconfiguration/applications/application/uripatterns/uripattern"
					, "AttributeAdded: match | contains"
					, "AttributeAdded: pattern | http://services.gehealthcare.com/"
					, "ElementHeader: uripattern | dynatrace/systemprofile/uemconfiguration/applications/application/uripatterns/uripattern"
					, "AttributeAdded: match | contains"
					, "AttributeAdded: pattern | https://services.gehealthcare.com/"
					, "ElementHeader: uripattern | dynatrace/systemprofile/uemconfiguration/applications/application/uripatterns/uripattern"
					, "AttributeAdded: match | contains"
					, "AttributeAdded: pattern | www.services.gehealthcare.com"
					, "ElementHeader: application | dynatrace/systemprofile/uemconfiguration/applications/application"
					, "AttributeAdded: autodetecttype | none"
					, "AttributeAdded: isdefault | false"
					, "AttributeAdded: name | CS Cockpit - stg-services.gehealthcare.com/cs"
					, "ElementHeader: uripattern | dynatrace/systemprofile/uemconfiguration/applications/application/uripatterns/uripattern"
					, "AttributeAdded: match | contains"
					, "AttributeAdded: pattern | stg-services.gehealthcare.com/cs"
			...
			element = element.peer; // Other side
			
			checkAttributes(Arrays.asList(
					  "ElementHeader: systemprofile | dynatrace/systemprofile"
					, "AttributeValueDifferent: gomezconvergenceid | 1428594694"
					, "AttributeValueDifferent: modifiedby | admin"
					, "ElementHeader: technology:javax | dynatrace/systemprofile/technology:javax"
					, "AttributeRemoved: type | javax"
					, "ElementHeader: agentgroups | dynatrace/systemprofile/agentgroups"
					, "AttributeRemoved: attributeOnlyInStaging | yes"
					, "ElementHeader: agentmapping:hybris_accelerator | dynatrace/systemprofile/agentgroups/agentgroup:hybris accelerator/agentmappings/agentmapping:hybris_accelerator"
					, "AttributeValueDifferent: hostpattern | geh-s-ma-app"
					, "AttributeValueDifferent: namepattern | geh-s-ma-app"
					, "ElementHeader: agentmapping:hybris_webserver | dynatrace/systemprofile/agentgroups/agentgroup:hybris webserver/agentmappings/agentmapping:hybris_webserver"
					, "AttributeValueDifferent: hostpattern | geh-s-ma-web"
					, "AttributeValueDifferent: namepattern | geh-s-ma-web"
					, "ElementHeader: measure:Execution CPU Time Azurecloud:API Breakdown:Execution CPU Time | dynatrace/systemprofile/measures/measure:Execution CPU Time Azurecloud:API Breakdown:Execution CPU Time"
					, "AttributeRemoved: api | Azurecloud"
					, "AttributeRemoved: apimatch | equals"
					, "AttributeRemoved: calculatebaseline | false"
					, "AttributeRemoved: calculatepercentiles | false"
					, "AttributeRemoved: description | Represents the CPU time that has been spent on methods of the given API without calls to other APIs."
					, "AttributeRemoved: displayaggregations | 31"
					, "AttributeRemoved: displayunit | ms"
					, "AttributeRemoved: errorseverity | none"
					, "AttributeRemoved: errortype | none"
					, "AttributeRemoved: id | Execution CPU Time Azurecloud"
					, "AttributeRemoved: isaggregated | true"
					, "AttributeRemoved: isapplicationaggregated | false"
					, "AttributeRemoved: ischartable | true"
					, "AttributeRemoved: measuretype | ApiMeasure"
					, "AttributeRemoved: metricgroupid | API Breakdown"
					, "AttributeRemoved: metricid | Execution CPU Time"
					, "AttributeRemoved: rate | purepath"
					, "AttributeRemoved: servicecontext | SERVER"
					, "AttributeRemoved: userdefined | true"
					, "ElementHeader: measure:Execution CPU Time Bmecat:API Breakdown:Execution CPU Time | dynatrace/systemprofile/measures/measure:Execution CPU Time Bmecat:API Breakdown:Execution CPU Time"
					, "AttributeRemoved: api | Bmecat"
					, "AttributeRemoved: apimatch | equals"
					, "AttributeRemoved: calculatebaseline | false"
					, "AttributeRemoved: calculatepercentiles | false"
					, "AttributeRemoved: description | Represents the CPU time that has been spent on methods of the given API without calls to other APIs."
					...
					, "AttributeRemoved: errorseverity | none"
					, "AttributeRemoved: errortype | none"
					, "AttributeRemoved: id | Execution CPU Time Bmecat"
					, "AttributeRemoved: isaggregated | true"
					, "AttributeRemoved: isapplicationaggregated | false"
					, "AttributeRemoved: ischartable | true"
					, "AttributeRemoved: measuretype | ApiMeasure"
					...
					, "AttributeRemoved: servicecontext | SERVER"
					, "AttributeRemoved: userdefined | true"
					, "ElementHeader: measure:Execution CPU Time Bmecathmc:API Breakdown:Execution CPU Time | dynatrace/systemprofile/measures/measure:Execution CPU Time Bmecathmc:API Breakdown:Execution CPU Time"
					, "AttributeRemoved: api | Bmecathmc"
					, "AttributeRemoved: apimatch | equals"
					, "AttributeRemoved: calculatebaseline | false"
					, "AttributeRemoved: calculatepercentiles | false"
					, "AttributeRemoved: description | Represents the CPU time that has been spent on methods of the given API without calls to other APIs."
					...
					, "AttributeRemoved: errorseverity | none"
					, "AttributeRemoved: errortype | none"
					, "AttributeRemoved: id | Execution CPU Time Bmecathmc"
					, "AttributeRemoved: isaggregated | true"
					, "AttributeRemoved: isapplicationaggregated | false"
					, "AttributeRemoved: ischartable | true"
					, "AttributeRemoved: measuretype | ApiMeasure"
					...
					, "AttributeRemoved: servicecontext | SERVER"
					, "AttributeRemoved: userdefined | true"
					, "ElementHeader: measure:Execution CPU Time Collection:API Breakdown:Execution CPU Time | dynatrace/systemprofile/measures/measure:Execution CPU Time Collection:API Breakdown:Execution CPU Time"
					, "AttributeRemoved: api | Collection"
					, "AttributeRemoved: apimatch | equals"
					, "AttributeRemoved: calculatebaseline | false"
					, "AttributeRemoved: calculatepercentiles | false"
					, "AttributeRemoved: description | Represents the CPU time that has been spent on methods of the given API without calls to other APIs."
					...
					, "AttributeRemoved: errorseverity | none"
					, "AttributeRemoved: errortype | none"
					, "AttributeRemoved: id | Execution CPU Time Collection"
					, "AttributeRemoved: isaggregated | true"
					, "AttributeRemoved: isapplicationaggregated | false"
					, "AttributeRemoved: ischartable | true"
					, "AttributeRemoved: measuretype | ApiMeasure"
					...
					, "AttributeRemoved: servicecontext | SERVER"
					, "AttributeRemoved: userdefined | true"
					, "ElementHeader: measure:Execution CPU Time Hyend2:API Breakdown:Execution CPU Time | dynatrace/systemprofile/measures/measure:Execution CPU Time Hyend2:API Breakdown:Execution CPU Time"
					, "AttributeRemoved: api | Hyend2"
					, "AttributeRemoved: apimatch | equals"
					, "AttributeRemoved: calculatebaseline | false"
					, "AttributeRemoved: calculatepercentiles | false"
					, "AttributeRemoved: description | Represents the CPU time that has been spent on methods of the given API without calls to other APIs."
					...
					, "AttributeRemoved: errorseverity | none"
					, "AttributeRemoved: errortype | none"
					, "AttributeRemoved: id | Execution CPU Time Hyend2"
					, "AttributeRemoved: isaggregated | true"
					, "AttributeRemoved: isapplicationaggregated | false"
					, "AttributeRemoved: ischartable | true"
					, "AttributeRemoved: measuretype | ApiMeasure"
					...
					, "AttributeRemoved: servicecontext | SERVER"
					, "AttributeRemoved: userdefined | true"
					, "ElementHeader: measure:Execution CPU Time Importcockpit:API Breakdown:Execution CPU Time | dynatrace/systemprofile/measures/measure:Execution CPU Time Importcockpit:API Breakdown:Execution CPU Time"
					, "AttributeRemoved: api | Importcockpit"
					, "AttributeRemoved: apimatch | equals"
					, "AttributeRemoved: calculatebaseline | false"
					, "AttributeRemoved: calculatepercentiles | false"
					, "AttributeRemoved: description | Represents the CPU time that has been spent on methods of the given API without calls to other APIs."
					...
					, "AttributeRemoved: errorseverity | none"
					, "AttributeRemoved: errortype | none"
					, "AttributeRemoved: id | Execution CPU Time Importcockpit"
					, "AttributeRemoved: isaggregated | true"
					, "AttributeRemoved: isapplicationaggregated | false"
					, "AttributeRemoved: ischartable | true"
					, "AttributeRemoved: measuretype | ApiMeasure"
					...
					, "AttributeRemoved: servicecontext | SERVER"
					, "AttributeRemoved: userdefined | true"
					, "ElementHeader: measure:Execution CPU Time Mam:API Breakdown:Execution CPU Time | dynatrace/systemprofile/measures/measure:Execution CPU Time Mam:API Breakdown:Execution CPU Time"
					, "AttributeRemoved: api | Mam"
					, "AttributeRemoved: apimatch | equals"
					, "AttributeRemoved: calculatebaseline | false"
					, "AttributeRemoved: calculatepercentiles | false"
					, "AttributeRemoved: description | Represents the CPU time that has been spent on methods of the given API without calls to other APIs."
					...
					, "AttributeRemoved: errorseverity | none"
					, "AttributeRemoved: errortype | none"
					, "AttributeRemoved: id | Execution CPU Time Mam"
					, "AttributeRemoved: isaggregated | true"
					, "AttributeRemoved: isapplicationaggregated | false"
					, "AttributeRemoved: ischartable | true"
					, "AttributeRemoved: measuretype | ApiMeasure"
					...
					, "AttributeRemoved: servicecontext | SERVER"
					, "AttributeRemoved: userdefined | true"
					, "ElementHeader: measure:Execution CPU Time Mamdemo:API Breakdown:Execution CPU Time | dynatrace/systemprofile/measures/measure:Execution CPU Time Mamdemo:API Breakdown:Execution CPU Time"
					, "AttributeRemoved: api | Mamdemo"
					, "AttributeRemoved: apimatch | equals"
					, "AttributeRemoved: calculatebaseline | false"
					, "AttributeRemoved: calculatepercentiles | false"
					, "AttributeRemoved: description | Represents the CPU time that has been spent on methods of the given API without calls to other APIs."
					...
					, "AttributeRemoved: errorseverity | none"
					, "AttributeRemoved: errortype | none"
					, "AttributeRemoved: id | Execution CPU Time Mamdemo"
					, "AttributeRemoved: isaggregated | true"
					, "AttributeRemoved: isapplicationaggregated | false"
					, "AttributeRemoved: ischartable | true"
					, "AttributeRemoved: measuretype | ApiMeasure"
					...
					, "AttributeRemoved: servicecontext | SERVER"
					, "AttributeRemoved: userdefined | true"
					, "ElementHeader: measure:Execution CPU Time Print:API Breakdown:Execution CPU Time | dynatrace/systemprofile/measures/measure:Execution CPU Time Print:API Breakdown:Execution CPU Time"
					, "AttributeRemoved: api | Print"
					, "AttributeRemoved: apimatch | equals"
					, "AttributeRemoved: calculatebaseline | false"
					, "AttributeRemoved: calculatepercentiles | false"
					, "AttributeRemoved: description | Represents the CPU time that has been spent on methods of the given API without calls to other APIs."
					...
					, "AttributeRemoved: errorseverity | none"
					, "AttributeRemoved: errortype | none"
					, "AttributeRemoved: id | Execution CPU Time Print"
					, "AttributeRemoved: isaggregated | true"
					, "AttributeRemoved: isapplicationaggregated | false"
					, "AttributeRemoved: ischartable | true"
					, "AttributeRemoved: measuretype | ApiMeasure"
					...
					, "AttributeRemoved: servicecontext | SERVER"
					, "AttributeRemoved: userdefined | true"
					, "ElementHeader: measure:Execution CPU Time Printcockpit:API Breakdown:Execution CPU Time | dynatrace/systemprofile/measures/measure:Execution CPU Time Printcockpit:API Breakdown:Execution CPU Time"
					, "AttributeRemoved: api | Printcockpit"
					, "AttributeRemoved: apimatch | equals"
					, "AttributeRemoved: calculatebaseline | false"
					, "AttributeRemoved: calculatepercentiles | false"
					, "AttributeRemoved: description | Represents the CPU time that has been spent on methods of the given API without calls to other APIs."
					...
					, "AttributeRemoved: errorseverity | none"
					, "AttributeRemoved: errortype | none"
					, "AttributeRemoved: id | Execution CPU Time Printcockpit"
					, "AttributeRemoved: isaggregated | true"
					, "AttributeRemoved: isapplicationaggregated | false"
					, "AttributeRemoved: ischartable | true"
					, "AttributeRemoved: measuretype | ApiMeasure"
					...
					, "AttributeRemoved: servicecontext | SERVER"
					, "AttributeRemoved: userdefined | true"
					, "ElementHeader: measure:Execution CPU Time Yacceleratorfulfilmentprocess:API Breakdown:Execution CPU Time | dynatrace/systemprofile/measures/measure:Execution CPU Time Yacceleratorfulfilmentprocess:API Breakdown:Execution CPU Time"
					, "AttributeRemoved: api | Yacceleratorfulfilmentprocess"
					, "AttributeRemoved: apimatch | equals"
					, "AttributeRemoved: calculatebaseline | false"
					, "AttributeRemoved: calculatepercentiles | false"
					, "AttributeRemoved: description | Represents the CPU time that has been spent on methods of the given API without calls to other APIs."
					...
					, "AttributeRemoved: errorseverity | none"
					, "AttributeRemoved: errortype | none"
					, "AttributeRemoved: id | Execution CPU Time Yacceleratorfulfilmentprocess"
					, "AttributeRemoved: isaggregated | true"
					, "AttributeRemoved: isapplicationaggregated | false"
					, "AttributeRemoved: ischartable | true"
					, "AttributeRemoved: measuretype | ApiMeasure"
					...
					, "AttributeRemoved: servicecontext | SERVER"
					, "AttributeRemoved: userdefined | true"
					, "ElementHeader: measure:Execution CPU Time Yempty:API Breakdown:Execution CPU Time | dynatrace/systemprofile/measures/measure:Execution CPU Time Yempty:API Breakdown:Execution CPU Time"
					, "AttributeRemoved: api | Yempty"
					, "AttributeRemoved: apimatch | equals"
					, "AttributeRemoved: calculatebaseline | false"
					, "AttributeRemoved: calculatepercentiles | false"
					, "AttributeRemoved: description | Represents the CPU time that has been spent on methods of the given API without calls to other APIs."
					...
					, "AttributeRemoved: errorseverity | none"
					, "AttributeRemoved: errortype | none"
					, "AttributeRemoved: id | Execution CPU Time Yempty"
					, "AttributeRemoved: isaggregated | true"
					, "AttributeRemoved: isapplicationaggregated | false"
					, "AttributeRemoved: ischartable | true"
					, "AttributeRemoved: measuretype | ApiMeasure"
					...
					, "AttributeRemoved: servicecontext | SERVER"
					, "AttributeRemoved: userdefined | true"
					, "ElementHeader: measure:Execution Time Azurecloud:API Breakdown:Execution Time | dynatrace/systemprofile/measures/measure:Execution Time Azurecloud:API Breakdown:Execution Time"
					, "AttributeRemoved: api | Azurecloud"
					, "AttributeRemoved: apimatch | equals"
					, "AttributeRemoved: calculatebaseline | false"
					, "AttributeRemoved: calculatepercentiles | false"
					, "AttributeRemoved: description | Represents the time that has been spent on methods of the given API without calls to other APIs."
					, "AttributeRemoved: displayaggregations | 31"
					, "AttributeRemoved: displayunit | ms"
					, "AttributeRemoved: errorseverity | none"
					, "AttributeRemoved: errortype | none"
					, "AttributeRemoved: id | Execution Time Azurecloud"
					, "AttributeRemoved: isaggregated | true"
					, "AttributeRemoved: isapplicationaggregated | false"
					, "AttributeRemoved: ischartable | true"
					, "AttributeRemoved: measuretype | ApiMeasure"
					, "AttributeRemoved: metricgroupid | API Breakdown"
					, "AttributeRemoved: metricid | Execution Time"
					, "AttributeRemoved: rate | purepath"
					, "AttributeRemoved: servicecontext | SERVER"
					, "AttributeRemoved: userdefined | true"
					, "ElementHeader: measure:Execution Time Bmecat:API Breakdown:Execution Time | dynatrace/systemprofile/measures/measure:Execution Time Bmecat:API Breakdown:Execution Time"
					, "AttributeRemoved: api | Bmecat"
					, "AttributeRemoved: apimatch | equals"
					, "AttributeRemoved: calculatebaseline | false"
					, "AttributeRemoved: calculatepercentiles | false"
					...
					, "AttributeRemoved: errorseverity | none"
					, "AttributeRemoved: errortype | none"
					, "AttributeRemoved: id | Execution Time Bmecat"
					, "AttributeRemoved: isaggregated | true"
					, "AttributeRemoved: isapplicationaggregated | false"
					, "AttributeRemoved: ischartable | true"
					, "AttributeRemoved: measuretype | ApiMeasure"
					...
					, "AttributeRemoved: servicecontext | SERVER"
					, "AttributeRemoved: userdefined | true"
					, "ElementHeader: measure:Execution Time Bmecathmc:API Breakdown:Execution Time | dynatrace/systemprofile/measures/measure:Execution Time Bmecathmc:API Breakdown:Execution Time"
					, "AttributeRemoved: api | Bmecathmc"
					, "AttributeRemoved: apimatch | equals"
					, "AttributeRemoved: calculatebaseline | false"
					, "AttributeRemoved: calculatepercentiles | false"
					...
					, "AttributeRemoved: errorseverity | none"
					, "AttributeRemoved: errortype | none"
					, "AttributeRemoved: id | Execution Time Bmecathmc"
					, "AttributeRemoved: isaggregated | true"
					, "AttributeRemoved: isapplicationaggregated | false"
					, "AttributeRemoved: ischartable | true"
					, "AttributeRemoved: measuretype | ApiMeasure"
					...
					, "AttributeRemoved: servicecontext | SERVER"
					, "AttributeRemoved: userdefined | true"
					, "ElementHeader: measure:Execution Time Collection:API Breakdown:Execution Time | dynatrace/systemprofile/measures/measure:Execution Time Collection:API Breakdown:Execution Time"
					, "AttributeRemoved: api | Collection"
					, "AttributeRemoved: apimatch | equals"
					, "AttributeRemoved: calculatebaseline | false"
					, "AttributeRemoved: calculatepercentiles | false"
					...
					, "AttributeRemoved: errorseverity | none"
					, "AttributeRemoved: errortype | none"
					, "AttributeRemoved: id | Execution Time Collection"
					, "AttributeRemoved: isaggregated | true"
					, "AttributeRemoved: isapplicationaggregated | false"
					, "AttributeRemoved: ischartable | true"
					, "AttributeRemoved: measuretype | ApiMeasure"
					...
					, "AttributeRemoved: servicecontext | SERVER"
					, "AttributeRemoved: userdefined | true"
					, "ElementHeader: measure:Execution Time Hyend2:API Breakdown:Execution Time | dynatrace/systemprofile/measures/measure:Execution Time Hyend2:API Breakdown:Execution Time"
					, "AttributeRemoved: api | Hyend2"
					, "AttributeRemoved: apimatch | equals"
					, "AttributeRemoved: calculatebaseline | false"
					, "AttributeRemoved: calculatepercentiles | false"
					...
					, "AttributeRemoved: errorseverity | none"
					, "AttributeRemoved: errortype | none"
					, "AttributeRemoved: id | Execution Time Hyend2"
					, "AttributeRemoved: isaggregated | true"
					, "AttributeRemoved: isapplicationaggregated | false"
					, "AttributeRemoved: ischartable | true"
					, "AttributeRemoved: measuretype | ApiMeasure"
					...
					, "AttributeRemoved: servicecontext | SERVER"
					, "AttributeRemoved: userdefined | true"
					, "ElementHeader: measure:Execution Time Importcockpit:API Breakdown:Execution Time | dynatrace/systemprofile/measures/measure:Execution Time Importcockpit:API Breakdown:Execution Time"
					, "AttributeRemoved: api | Importcockpit"
					, "AttributeRemoved: apimatch | equals"
					, "AttributeRemoved: calculatebaseline | false"
					, "AttributeRemoved: calculatepercentiles | false"
					...
					, "AttributeRemoved: errorseverity | none"
					, "AttributeRemoved: errortype | none"
					, "AttributeRemoved: id | Execution Time Importcockpit"
					, "AttributeRemoved: isaggregated | true"
					, "AttributeRemoved: isapplicationaggregated | false"
					, "AttributeRemoved: ischartable | true"
					, "AttributeRemoved: measuretype | ApiMeasure"
					...
					, "AttributeRemoved: servicecontext | SERVER"
					, "AttributeRemoved: userdefined | true"
					, "ElementHeader: measure:Execution Time Mam:API Breakdown:Execution Time | dynatrace/systemprofile/measures/measure:Execution Time Mam:API Breakdown:Execution Time"
					, "AttributeRemoved: api | Mam"
					, "AttributeRemoved: apimatch | equals"
					, "AttributeRemoved: calculatebaseline | false"
					, "AttributeRemoved: calculatepercentiles | false"
					...
					, "AttributeRemoved: errorseverity | none"
					, "AttributeRemoved: errortype | none"
					, "AttributeRemoved: id | Execution Time Mam"
					, "AttributeRemoved: isaggregated | true"
					, "AttributeRemoved: isapplicationaggregated | false"
					, "AttributeRemoved: ischartable | true"
					, "AttributeRemoved: measuretype | ApiMeasure"
					...
					, "AttributeRemoved: servicecontext | SERVER"
					, "AttributeRemoved: userdefined | true"
					, "ElementHeader: measure:Execution Time Mamdemo:API Breakdown:Execution Time | dynatrace/systemprofile/measures/measure:Execution Time Mamdemo:API Breakdown:Execution Time"
					, "AttributeRemoved: api | Mamdemo"
					, "AttributeRemoved: apimatch | equals"
					, "AttributeRemoved: calculatebaseline | false"
					, "AttributeRemoved: calculatepercentiles | false"
					...
					, "AttributeRemoved: errorseverity | none"
					, "AttributeRemoved: errortype | none"
					, "AttributeRemoved: id | Execution Time Mamdemo"
					, "AttributeRemoved: isaggregated | true"
					, "AttributeRemoved: isapplicationaggregated | false"
					, "AttributeRemoved: ischartable | true"
					, "AttributeRemoved: measuretype | ApiMeasure"
					...
					, "AttributeRemoved: servicecontext | SERVER"
					, "AttributeRemoved: userdefined | true"
					, "ElementHeader: measure:Execution Time Print:API Breakdown:Execution Time | dynatrace/systemprofile/measures/measure:Execution Time Print:API Breakdown:Execution Time"
					, "AttributeRemoved: api | Print"
					, "AttributeRemoved: apimatch | equals"
					, "AttributeRemoved: calculatebaseline | false"
					, "AttributeRemoved: calculatepercentiles | false"
					...
					, "AttributeRemoved: errorseverity | none"
					, "AttributeRemoved: errortype | none"
					, "AttributeRemoved: id | Execution Time Print"
					, "AttributeRemoved: isaggregated | true"
					, "AttributeRemoved: isapplicationaggregated | false"
					, "AttributeRemoved: ischartable | true"
					, "AttributeRemoved: measuretype | ApiMeasure"
					...
					, "AttributeRemoved: servicecontext | SERVER"
					, "AttributeRemoved: userdefined | true"
					, "ElementHeader: measure:Execution Time Printcockpit:API Breakdown:Execution Time | dynatrace/systemprofile/measures/measure:Execution Time Printcockpit:API Breakdown:Execution Time"
					, "AttributeRemoved: api | Printcockpit"
					, "AttributeRemoved: apimatch | equals"
					, "AttributeRemoved: calculatebaseline | false"
					, "AttributeRemoved: calculatepercentiles | false"
					...
					, "AttributeRemoved: errorseverity | none"
					, "AttributeRemoved: errortype | none"
					, "AttributeRemoved: id | Execution Time Printcockpit"
					, "AttributeRemoved: isaggregated | true"
					, "AttributeRemoved: isapplicationaggregated | false"
					, "AttributeRemoved: ischartable | true"
					, "AttributeRemoved: measuretype | ApiMeasure"
					...
					, "AttributeRemoved: servicecontext | SERVER"
					, "AttributeRemoved: userdefined | true"
					, "ElementHeader: measure:Execution Time Yacceleratorfulfilmentprocess:API Breakdown:Execution Time | dynatrace/systemprofile/measures/measure:Execution Time Yacceleratorfulfilmentprocess:API Breakdown:Execution Time"
					, "AttributeRemoved: api | Yacceleratorfulfilmentprocess"
					, "AttributeRemoved: apimatch | equals"
					, "AttributeRemoved: calculatebaseline | false"
					, "AttributeRemoved: calculatepercentiles | false"
					...
					, "AttributeRemoved: errorseverity | none"
					, "AttributeRemoved: errortype | none"
					, "AttributeRemoved: id | Execution Time Yacceleratorfulfilmentprocess"
					, "AttributeRemoved: isaggregated | true"
					, "AttributeRemoved: isapplicationaggregated | false"
					, "AttributeRemoved: ischartable | true"
					, "AttributeRemoved: measuretype | ApiMeasure"
					...
					, "AttributeRemoved: servicecontext | SERVER"
					, "AttributeRemoved: userdefined | true"
					, "ElementHeader: measure:Execution Time Yempty:API Breakdown:Execution Time | dynatrace/systemprofile/measures/measure:Execution Time Yempty:API Breakdown:Execution Time"
					, "AttributeRemoved: api | Yempty"
					, "AttributeRemoved: apimatch | equals"
					, "AttributeRemoved: calculatebaseline | false"
					, "AttributeRemoved: calculatepercentiles | false"
					...
					, "AttributeRemoved: errorseverity | none"
					, "AttributeRemoved: errortype | none"
					, "AttributeRemoved: id | Execution Time Yempty"
					, "AttributeRemoved: isaggregated | true"
					, "AttributeRemoved: isapplicationaggregated | false"
					, "AttributeRemoved: ischartable | true"
					, "AttributeRemoved: measuretype | ApiMeasure"
					...
					, "AttributeRemoved: userdefined | true"
					, "ElementHeader: measure:Failed Transaction Count:Error Detection:Failed Transaction Count | dynatrace/systemprofile/measures/measure:Failed Transaction Count:Error Detection:Failed Transaction Count"
					, "AttributeValueDifferent: calculatebaseline | false"
					, "ElementHeader: measure:Failed Transaction Count of Web Page Requests:Error Detection:Failed Transaction Count | dynatrace/systemprofile/measures/measure:Failed Transaction Count of Web Page Requests:Error Detection:Failed Transaction Count"
					, "AttributeValueDifferent: calculatebaseline | false"
					, "ElementHeader: measure:Web Page Requests:Business Transaction Results:Value:Web Page Requests | dynatrace/systemprofile/measures/measure:Failed Transaction Count of Web Page Requests:Error Detection:Failed Transaction Count/sourcemeasure/measure:Web Page Requests:Business Transaction Results:Value:Web Page Requests"
					, "AttributeValueDifferent: calculatebaseline | false"
					...
					, "AttributeValueDifferent: calculatebaseline | false"
					, "ElementHeader: uemconfiguration | dynatrace/systemprofile/uemconfiguration"
					, "AttributeValueDifferent: autodetecttype | autodetect_domain"
					, "ElementHeader: measure:Web Page Requests by URI (PurePath Response Time;PurePaths;PurePath Response Time):Business Transaction Results:Value:Web Page Requests by URI | dynatrace/systemprofile/transactions/transaction:Web Page Requests by URI/value/measure:Web Page Requests by URI (PurePath Response Time;PurePaths;PurePath Response Time):Business Transaction Results:Value:Web Page Requests by URI"
					, "AttributeValueDifferent: calculatebaseline | false"
					, "ElementHeader: measure:Web Page Requests by URI (Slow;Threshold Violations;Count):Business Transaction Results:Value:Web Page Requests by URI | dynatrace/systemprofile/transactions/transaction:Web Page Requests by URI/value/measure:Web Page Requests by URI (Slow;Threshold Violations;Count):Business Transaction Results:Value:Web Page Requests by URI"
					, "AttributeValueDifferent: calculatebaseline | false"
					...
					, "ElementHeader: measure:webrequests - 0s to 1s:Business Transaction Results:Value:webrequests - 0s to 1s | dynatrace/systemprofile/transactions/transaction:webrequests - 0s to 1s/value/measure:webrequests - 0s to 1s:Business Transaction Results:Value:webrequests - 0s to 1s"
					, "AttributeValueDifferent: calculatebaseline | false"
					, "ElementHeader: actionref:com.dynatrace.diagnostics.logging | dynatrace/systemprofile/incidentrules/incidentrule:Deployment/actions/actionref:com.dynatrace.diagnostics.logging"
					, "AttributeRemoved: bundleversion | 0.0.0"
					, "AttributeRemoved: execution | begin"
					, "AttributeRemoved: key | com.dynatrace.diagnostics.logging"
					, "AttributeRemoved: refaction | com.dynatrace.diagnostics.logging"
					, "AttributeRemoved: rolekey | com.dynatrace.diagnostics.logging"
					, "AttributeRemoved: roletype | 1"
					, "AttributeRemoved: severity | informational"
					, "AttributeRemoved: smartalert | false"
					, "AttributeRemoved: type | Logging Notification"
					), element, compare, changesOnly, allAttributes, includeChildren);
		}
		...
		
		{
			...
			checkAttributes(Arrays.asList(
					  "ElementHeader: measure:Failed Transaction Count of Web Page Requests:Error Detection:Failed Transaction Count | dynatrace/systemprofile/measures/measure:Failed Transaction Count of Web Page Requests:Error Detection:Failed Transaction Count"
					, "AttributeValueDifferent: calculatebaseline | true"
					, "AttributeValueEqual: calculatepercentiles | false"
					, "AttributeValueEqual: description | Number of Failed Transactions."
					, "AttributeValueEqual: displayaggregations | 31"
					, "AttributeValueEqual: displayunit | number"
					, "AttributeValueEqual: errorseverity | error_causing_transaction_fail"
					, "AttributeValueEqual: errortype | none"
					, "AttributeValueEqual: id | Failed Transaction Count of Web Page Requests"
					, "AttributeValueEqual: isaggregated | true"
					, "AttributeValueEqual: isapplicationaggregated | false"
					, "AttributeValueEqual: ischartable | true"
					, "AttributeValueEqual: measuretype | ErrorDetectionMeasure"
					, "AttributeValueEqual: metricgroupid | Error Detection"
					, "AttributeValueEqual: metricid | Failed Transaction Count"
					, "AttributeValueEqual: rate | purepath"
					, "AttributeValueEqual: servicecontext | SERVER"
					, "AttributeValueEqual: thresholdseverity | severe"
					, "AttributeValueEqual: userdefined | false"
					, "ElementHeader: measure:Web Page Requests:Business Transaction Results:Value:Web Page Requests | dynatrace/systemprofile/measures/measure:Failed Transaction Count of Web Page Requests:Error Detection:Failed Transaction Count/sourcemeasure/measure:Web Page Requests:Business Transaction Results:Value:Web Page Requests"
					, "AttributeValueEqual: aggregategroups | true"
					, "AttributeValueDifferent: calculatebaseline | true"
					, "AttributeValueEqual: calculatepercentiles | true"
					, "AttributeValueEqual: description | -"
					, "AttributeValueEqual: displayaggregations | 31"
					, "AttributeValueEqual: displayunit | ms"
					, "AttributeValueEqual: errorseverity | none"
					, "AttributeValueEqual: errortype | none"
					, "AttributeValueEqual: id | Web Page Requests"
					, "AttributeValueEqual: isaggregated | true"
					, "AttributeValueEqual: isapplicationaggregated | false"
					, "AttributeValueEqual: ischartable | true"
					, "AttributeValueEqual: isnumerical | true"
					, "AttributeValueEqual: measuretype | TransactionMeasure"
					, "AttributeValueEqual: metricgroupid | Business Transaction Results"
					, "AttributeValueEqual: metricid | Value"
					, "AttributeValueEqual: rate | purepath"
					, "AttributeValueEqual: servicecontext | SERVER"
					, "AttributeValueEqual: transactionname | Web Page Requests"
					, "AttributeValueEqual: userdefined | false"
					), element, compare, changesOnly, allAttributes, includeChildren);
		...
		
		{
			...
			checkAttributes(Arrays.asList(
					...
					, "AttributeValueDifferent: calculatebaseline | true"
					, "AttributeValueEqual: calculatepercentiles | false"
					, "AttributeValueDifferent: createdtimestamp | 1415717400528"
					, "AttributeValueEqual: description | Number of Failed Transactions."
					, "AttributeValueEqual: displayaggregations | 31"
					, "AttributeValueEqual: displayunit | number"
					, "AttributeValueEqual: errorseverity | error_causing_transaction_fail"
					...
					, "AttributeValueEqual: color.blue | 25"
					, "AttributeValueEqual: color.green | 25"
					, "AttributeValueEqual: color.red | 205"
					, "ElementHeader: measure:Web Page Requests:Business Transaction Results:Value:Web Page Requests | dynatrace/systemprofile/measures/measure:Failed Transaction Count of Web Page Requests:Error Detection:Failed Transaction Count/sourcemeasure/measure:Web Page Requests:Business Transaction Results:Value:Web Page Requests"
					, "AttributeValueEqual: aggregategroups | true"
					, "AttributeValueDifferent: calculatebaseline | true"
					, "AttributeValueEqual: calculatepercentiles | true"
					...
					, "AttributeValueEqual: color.blue | 0"
					, "AttributeValueEqual: color.green | 64"
					, "AttributeValueEqual: color.red | 128"
					), element, compare, changesOnly, allAttributes, includeChildren);
			...
			checkAttributes(Arrays.asList(
					...
					, "AttributeValueDifferent: calculatebaseline | false"
					, "AttributeValueEqual: calculatepercentiles | false"
					, "AttributeValueDifferent: createdtimestamp | 1415717413605"
					, "AttributeValueEqual: description | Number of Failed Transactions."
					, "AttributeValueEqual: displayaggregations | 31"
					, "AttributeValueEqual: displayunit | number"
					, "AttributeValueEqual: errorseverity | error_causing_transaction_fail"
		...
		
		{
			...
			checkAttributes(Arrays.asList(
					...
					, "calculatepercentiles | false"
					, "createdtimestamp | 1415717413605"
					, "description | Number of Failed Transactions."
					, "displayaggregations | 31"
					, "displayunit | number"
					, "errorseverity | error_causing_transaction_fail"
